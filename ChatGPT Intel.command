...
cd "${SCRIPT_DIR}"
BUILD_SCRIPT="${SCRIPT_DIR}/scripts/build-chatgpt-intel.sh"
OUTPUT_DMG="${SCRIPT_DIR}/ChatGPT-Intel.dmg"
LOG_FILE="${SCRIPT_DIR}/log-chatgpt.txt"
...
main() {
  clear
  printf '\n'
  printf '  \033[1;36mChatGPT Intel Builder\033[0m\n\n'
